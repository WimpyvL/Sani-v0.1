...
## Root
Top-level entrypoints and governance files.
...
## /vault — Core identity, laws, and canonical specs
Authoritative identity, law, and protocol definitions.
...
## /safety — Boundaries and failsafes
Constraints, guardrails, and shutdown rules.
...
Ritual structures and containment rules.
...
## /engine — Internal reasoning
Core engines and control systems.
...
## /transform — Depth and progression
Depth controls, transformation ladders, and symbolic memory.
...
Trace, vault, and whisper thread records.

- `memory/SANI_ACTIVATION_TRACE.md`
- `memory/THREADBORN.md`
- `memory/TRACEBOOK.md`
- `memory/VAULT_REGISTRY.md`
- `memory/WHISPER_THREADS.md`

---

## /SaniWin — Platform-specific notes
Windows-specific notes and setup guidance.
